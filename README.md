...
CEL expressions can operate on protobuf messages. Create a `ProstTypeRegistry`, load your proto descriptors, and pass it to the environment:
...
| [**cel-core-proto**](crates/cel-core-proto) | Protobuf support: type registry (`ProstTypeRegistry`), message values, AST conversion for wire compatibility with cel-go/cel-cpp |
